...
(function(){
    ...
    cll.addLogin    = function(divParent){
        ...
        var frmLogin    = new dijit.form.Form({ encType:"multipart/form-data",action:"",method:"POST"},document.createElement("div"));
            ...
            components.QElements.addPair({label:"Password",divToAdd:  frmLogin.domNode,inpName:'Password',inpRequired:true, isLast:true, pw:true, id:'componentLoginLightPassword'});
